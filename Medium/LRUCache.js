...
// Test cases
console.log(LRUCache(['A', 'B', 'C', 'D', 'A', 'E', 'D', 'Z'])); // Output: C-A-E-D-Z
console.log(LRUCache(['A', 'B', 'A', 'C', 'A', 'B'])); // Output: C-A-B
console.log(LRUCache(['A', 'B', 'C', 'D', 'E', 'D', 'Q', 'Z', 'C'])); // Output: E-D-Q-Z-C
console.log(LRUCache(['A', 'B', 'C', 'D', 'E', 'A', 'D', 'E', 'A', 'D'])); // Output: B-C-E-A-D
